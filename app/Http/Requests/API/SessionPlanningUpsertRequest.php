...
class SessionPlanningUpsertRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phases.*.diagram.*.id' => ['nullable', 'string', 'max:100'],
            ...
            'phases.*.diagram.*.label' => ['nullable', 'string', 'max:100'],
            'phases.*.diagram.*.color' => ['nullable', 'string', Rule::in(['blue', 'red', 'green', 'yellow', 'orange', 'black'])],
            'phases.*.diagram.*.rotation' => ['nullable', 'numeric'],
            'phases.*.diagram.*.strokeWidth' => ['nullable', 'numeric', 'between:0.1,10'],
