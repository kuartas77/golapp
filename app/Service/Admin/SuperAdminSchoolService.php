    ...
    public function formData(School $school): array
    {
        ...
        return [
            'school' => [
                ...
                'send_monthly_payment_receipts' => $school->send_monthly_payment_receipts,
                'send_debt_notifications' => $school->send_debt_notifications,
                'training_group_monthly_payment_enabled' => $school->training_group_monthly_payment_enabled,
