    ...
    <div class="sidebar-wrapper sidebar-theme" id="sidebar">
        <nav ref="menu" id="sidebar">
            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul"
                ...
                <li v-if="canDocumentPlanning" class="menu">
                    <router-link :to="{ name: 'document-planning.index' }" class="dropdown-toggle" @click="toggleMobileMenu"
                        v-tooltip.right="'Planificación documental'">
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="16" y2="17"/></svg>
                            <span>Plan. documental</span>
                        </div>
                    </router-link>
                </li>
