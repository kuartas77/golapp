        ...
        <div class="app-settings" :class="{ active: isOpen }">
            ...
            <perfect-scrollbar class="sidbarchat p-3" tag="div">
                ...
                <div class="text-center">
                    <img src="/img/logo-light.svg" alt="logo app" class="img-fluid" />
                </div>
                ...
                <div class="btn-group-toggle row mb-4 mx-0">
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="light_mode" v-model="appState.dark_mode" class="custom-control-input"
                            value="light" @change="setTemplateStyle" />
                    ...
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="dark_mode" v-model="appState.dark_mode" class="custom-control-input"
                            value="dark" @change="setTemplateStyle" />
                    ...
                    <div class="text-color radio-primary col-12 ps-0 custom-control custom-radio">
                        <input type="radio" id="system_mode" v-model="appState.dark_mode" class="custom-control-input"
                            value="system" @change="setTemplateStyle" />
                        <label class="custom-control-label" for="system_mode">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-airplay me-2">
                ...
                <div class="btn-group-toggle row mb-4 mx-0">
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="horizontal" v-model="appState.menu_style" class="custom-control-input"
                            value="horizontal" @change="setMenuStyle" />
                        <label class="custom-control-label" for="horizontal">Horizontal</label>
                    </div>
                    <div class="text-color radio-primary col-6 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="vertical" v-model="appState.menu_style" class="custom-control-input"
                            value="vertical" @change="setMenuStyle" />
                    ...
                    <div class="text-color radio-primary col-12 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="collapsible" v-model="appState.menu_style" class="custom-control-input"
                            value="collapsible-vertical" @change="setMenuStyle" />
                ...
                <div class="btn-group-toggle row mx-0">
                    <div class="text-color radio-primary col-3 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="boxed" v-model="appState.layout_style" class="custom-control-input"
                            value="boxed-layout" @change="setLayoutStyle" />
                    ...
                    <div class="text-color radio-primary col-5 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="largeboxed" v-model="appState.layout_style" class="custom-control-input"
                            value="large-boxed-layout" @change="setLayoutStyle" />
                    ...
                    <div class="text-color radio-primary col-4 ps-0 mb-3 custom-control custom-radio">
                        <input type="radio" id="full" v-model="appState.layout_style" class="custom-control-input"
                            value="full" @change="setLayoutStyle" />
...
const setTemplateStyle = () => {
    appState.toggleDarkMode(appState.dark_mode);
};

const setMenuStyle = () => {
    appState.toggleMenuStyle(appState.menu_style);
};

const setLayoutStyle = () => {
    appState.toggleLayoutStyle(appState.layout_style);
};
</script>