    ...
    <panel>
        ...
        <template #body>
            <div class="position-relative stats-page">
                ...
                <div class="surface-card mb-4"><div class="surface-card-body">
                ...
                <div class="surface-card overflow-hidden"><div class="surface-card-header"><h5 class="mb-1">Escalafón de grupos</h5><p class="text-muted mb-0">Orden: puntos, diferencia de gol, goles a favor y victorias.</p></div><div class="surface-card-body p-0">
