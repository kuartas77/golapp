            ...
            <div class="card border-0 shadow-sm guardian-dashboard__hero">
                <div class="card-body p-4 p-lg-5">
                    ...
                    <p class="text-muted mb-0">
                        {{ guardianName }}, aquí puedes consultar la información de los deportistas con inscripción activa en el año actual.
                    </p>
                </div>
            </div>
        </div>
...
<script setup>
defineProps({
    guardianName: { type: String, default: 'Acudiente' },
    groupedPlayers: { type: Array, default: () => [] },
