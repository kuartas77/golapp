    ...
    <div class="card">
        <div class="card-body">
            <div class="text-center">
                ...
                <h4 class="text-themecolor m-t-10">{{$player->full_names}}</h4>
                <h6 class="text-themecolor">@lang('messages.unique_code', ['unique_code'=> $player->unique_code])</h6>
            ...
            <hr>
            <div class="text-center">
                <a class="btn waves-effect waves-light btn-rounded btn-info btn-block"
