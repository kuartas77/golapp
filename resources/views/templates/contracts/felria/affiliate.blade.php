<h3>CONTRATO DE AFILIACIÓN Y CORRESPONSABILIDAD DEPORTIVA DEL {{ \Str::upper($school->name) }}</h3>
<h3>VIGENCIA {{now()->year}}</h3>

<h3>PREÁMBULO</h3>
<p>
    El presente reglamento pretende crear un conjunto de criterios de organización de las actividades deportivas del <strong>{{ \Str::upper($school->name) }}</strong>, Todas las personas que se integran, se comprometen a conocer y cumplir el presente reglamento de régimen interno. a título individual o bien a título de sus familiares. La creación de un ambiente agradable y disciplinado dentro del club deportivo es también una tarea que nos compete a todos y a la cual todos debemos de integrarnos. Ello nos permitirá un mayor nivel de satisfacción personal y colectivo, y también contribuirá sin duda a un mayor éxito deportivo. Por tanto, todos los jugadores están obligados al respeto que se establece en la presente normativa interna, sus deberes y funciones como padres de familia son las siguientes:
</p>
...
<p><strong>Artículo 8.</strong> Acatar y respetar las órdenes del profesor y actuar en la posición asignada para la competencia, el fútbol es un deporte de conjunto donde prima el bien colectivo sobre el individual, en caso de alguna inconformidad debe acercarse al profesor respetuosamente y manifestarlo o lo podrá hacer de manera escrita al coordinador general.</p>
<p><strong>Artículo 9.</strong> Apoyar a sus hijos sin interferir con el trabajo de los formadores; entender que <strong>{{ \Str::upper($school->name) }}</strong> tiene unas políticas institucionales y que como padres tienen todo el derecho a opinar y contribuir con el mejoramiento de los procesos. Más sobre una decisión técnica no tienen la autoridad para decir, quien tiene la autonomía y facultad para decidir es el formador encargado del grupo.</p>
...
<p><strong>Artículo 14.</strong> Presentarse a todas las actividades con los uniformes respectivos de entrenamiento, de competencia, de presentación. si el deportista no se presenta con la indumentaria correspondiente <strong>NO PODRÁ PARTICIPAR EN LA CLASE Y/O COMPETENCIA</strong> </p>
