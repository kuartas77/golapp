                        ...
                        <div class="row text-center">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <span class="bar"></span>
                                    {{ html()->select('day_one', $week, null)->attributes([['id'=>'day_one','class' => 'form-control form-control-sm select classes','required'])->placeholder('Selecciona...') }}
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <span class="bar"></span>
                                    {{ html()->select('day_two', $week, null)->attributes(['id'=>'day_two','class' => 'form-control form-control-sm select classes','required'])->placeholder('Selecciona...') }}
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <span class="bar"></span>
                                    {{ html()->select('day_three', $week, null)->attributes(['id'=>'day_three','class' => 'form-control form-control-sm select classes','required'])->placeholder('Selecciona...') }}
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <span class="bar"></span>
                                    {{ html()->select('day_four', $week, null)->attributes(['id'=>'day_four','class' => 'form-control form-control-sm select classes','required'])->placeholder('Selecciona...') }}
                                </div>
                            </div>
                            ...
                            {{--<div class="col">
                                <div class="form-group">
                                    ...
                                    <span class="bar"></span>
                                    {{ html()->select('day_five', $week, null)->attributes(['id'=>'day_five','class' => 'form-control form-control-sm select classes','required'])->placeholder('Selecciona...') }}
                                </div>
                            </div>--}}
