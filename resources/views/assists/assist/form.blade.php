    ...
    <div class="row form-body">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <span class="bar"></span>
                {{ html()->select('training_group_id', $training_groups, null)->attributes(['id'=>'training_group_id','class' => 'form-control form-control-sm','placeholder' => 'Seleccionar...', 'required']) }}
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <span class="bar"></span>
                {{ html()->select('month', $months, $actual_month)->attributes(['id'=>'month','class' => 'form-control form-control-sm', 'id'=>'month']) }}
            </div>
        </div>
