...
<x-row-card col-inside="12">
    ...
    <a class="float-right btn waves-effect waves-light btn-rounded btn-info" href="{{ route('player.stats') }}">
                <i class="fas fa-list-ol" aria-hidden="true"></i> Estadísticas de Jugadores y escalafón
            </a>
    <div class="row">
...
<script>
    ...
    $('body').on('change', 'select.sl', function() {
        ...
        $('table.dataTable').DataTable().ajax.url($.fn.dataTable.pipeline({
            url: ruta
        }));
