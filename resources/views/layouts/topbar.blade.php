    ...
    <header class="header navbar navbar-expand-sm expand-header">
        <ul class="navbar-item theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="{{route('home')}}">
                        <img src="{{asset('img/ballon_dark.png')}}" alt="logo" class="navbar-logo" width="34" height="15">
                </a>
            </li>
            <li class="nav-item theme-text">
                <a href="{{route('home')}}" class="nav-link">
                        <img src="{{asset('img/dark.png')}}" class="logo-text" alt="homepage" width="148" height="25">
                    </a>
            </li>
        </ul>
                ...
                <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar-container">
                        <div class="avatar avatar-sm avatar-indicators avatar-online">
                            <img alt="avatar" src="{{asset(getSchool(auth()->user())->logo_file)}}" class="rounded-circle">
                        </div>
                    </div>
                </a>
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <a href="{{route('profiles.show', [auth()->user()->profile->id])}}">
                            ...
                            </svg> <span>{{ __('messages.Profile') }}</span>
                        </a>
                    </div>
                    @endif
