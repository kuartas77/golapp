...
class CreatePaymentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('payments', function (Blueprint $table) {
            ...
            $table->float('enrollment_amount')->nullable()->default(0);
            $table->float('january_amount')->nullable()->default(0);
            $table->float('february_amount')->nullable()->default(0);
            $table->float('march_amount')->nullable()->default(0);
            $table->float('april_amount')->nullable()->default(0);
            $table->float('may_amount')->nullable()->default(0);
            $table->float('june_amount')->nullable()->default(0);
            $table->float('july_amount')->nullable()->default(0);
            $table->float('august_amount')->nullable()->default(0);
            $table->float('september_amount')->nullable()->default(0);
            $table->float('october_amount')->nullable()->default(0);
            $table->float('november_amount')->nullable()->default(0);
            $table->float('december_amount')->nullable()->default(0);
