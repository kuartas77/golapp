...
//         Route::get('escuelas/data', [SchoolsController::class, 'indexData'])->name('school.index.data');
//         Route::get('escuelas/{school}/data', [SchoolsController::class, 'showData'])->name('school.show.data');
//         Route::get('escuelas', [AppController::class, 'index'])->name('school.index');
//         Route::get('escuelas/{school}', [AppController::class, 'index'])->name('school.show');
