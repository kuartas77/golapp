...
Route::middleware(['auth', 'verified_school'])->group(function () {
    ...
    Route::prefix('export')->name('export.')->group(function () {
        ...
        Route::middleware([
            'role:super-admin|school|assistant|viewer',
            'school.module.view:school.module.inscriptions,school.module.payments,school.module.attendances,school.module.matches',
        ])->group(function () {
        ...
        Route::middleware(['role:super-admin|school|viewer', 'school.module.view:school.module.attendances'])->group(function () {
        ...
        Route::middleware(['role:super-admin|school|viewer', 'school.module.view:school.module.matches'])->group(function () {
    ...
    Route::middleware(['role:super-admin|school', 'school.permission:school.feature.system_notify'])->group(function () {
    ...
    Route::middleware([
        ...
        'school.module.view:school.module.evaluations',
    ])->prefix('player-evaluations')->name('player-evaluations.')->group(function () {
    ...
    Route::middleware([
        ...
        'school.permission:school.module.evaluations',
    ])->prefix('player-evaluations')->name('player-evaluations.')->group(function () {
