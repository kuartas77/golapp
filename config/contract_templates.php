...
return [
    'types' => [
        ...
        'affiliate' => [
            ...
            'file_label' => 'CONTRATO DE AFILIACION',
        ...
        'image_rights' => [
            'db_code' => 'image_rights',
            'fallback_id' => 3,
            'fallback_name' => 'AUTORIZACION USO DE IMAGEN',
            'label' => 'Autorizacion uso de imagen',
            'description' => 'Autorizacion para el uso de imagen del deportista.',
            'file_label' => 'AUTORIZACION USO DE IMAGEN',
            'pdf_view' => 'contracts/contract_inscription.blade.php',
            'acceptance_field' => 'contrato_image_rights',
            'portal' => [
                'requires_acceptance' => true,
                'requires_tutor_signature' => true,
                'requires_player_signature' => false,
